...
function k1_make_form_select_list(&$field_name, &$value, &$table_config_array, &$error_msg = "") {
    global $db;
...
//            $data_theme = "d";
    ...
    if ($mode == "edit") {
        ...
        if (($type_comparation !== false) && ($table_config_array[$field_name]['sql'] == "")) {
            ...
            return k1_make_form_select_list($field_name, $value, $table_config_array, $error_msg);
        } else {
            d($field_name);
        }
        return $html_code;
