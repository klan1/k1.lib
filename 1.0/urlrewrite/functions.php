...
function get_this_url($complete_url = true) {
    if ($complete_url) {
        ...
        return \k1lib\urlrewrite\make_url_from_rewrite();
    }
}

function get_this_controller_id() {
    $controller_url = \k1lib\urlrewrite\make_url_from_rewrite();
...
/**
 * This is an alias of "\k1lib\urlrewrite\get_app_link" with the $get_vars_to_keep parameter ready to use from the CONFIG file
