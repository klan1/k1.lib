...
namespace k1lib {
    ...
    if (!defined("K1LIB_VER")) {
        define("K1LIB_VER", "0.9");
    }

    define("K1LIB_PATH", $k1lib_local_dir);
    define("BASE_PATH", $k1lib_local_dir);

    const TEMPLATES_PATH = BASE_PATH . "/html-templates";

    $files_lv1 = scandir(K1LIB_PATH);
...
//set_include_path((K1LIB_PATH . '/_loaders') . PATH_SEPARATOR . get_include_path());
