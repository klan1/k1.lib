...
// see the max URL Level
        ...
        $this->controllerUrlLevel = \k1lib\urlrewrite\get_url_level_count() - 1;
...
//        d($this->controllerUrlRoot);
    ...
    public function setUrlLevel($urlLevelName, $required) {
        ...
        $urlLevelValue = \k1lib\urlrewrite\set_url_rewrite_var($this->nextUrlLevel, $urlLevelName, $required);
