...
//        'proxy' => $actual_proxy,
    ...
    k1_sql_insert($db, "CENSO2015_LOG", $censo_log);
    if ($return) {
...
function getFromLocalCache($cedula) {
    ...
    $local_sql_query_result = k1_sql_query($db, $local_sql_query, false);
    ...
    $local_sql_query_result_insc = k1_sql_query($db, $local_sql_query_insc, true);
...
function getFromLocalCenso($cedula) {
    ...
    $local_sql_query_censo_result = k1_sql_query($db, $local_sql_query_censo, false);
    ...
    $local_sql_query_baja_result = k1_sql_query($db, $local_sql_query_baja, false);
    ...
    $local_sql_query_novedad_result = k1_sql_query($db, $local_sql_query_novedad, false);
    ...
    $local_sql_query_transhumancia_result = k1_sql_query($db, $local_sql_query_transhumancia, false);
    ...
    if (isset($return_array['transhumancia']['IDDIVIPOLI']) && !empty($return_array['transhumancia']['IDDIVIPOLI'])) {
        ...
        $local_sql_query_transhumancia_i_result = k1_sql_query($db, $local_sql_query_transhumancia_i, false);
    ...
    if (isset($return_array['transhumancia']['IDDIVIPOLT']) && !empty($return_array['transhumancia']['IDDIVIPOLT'])) {
        ...
        $local_sql_query_transhumancia_t_result = k1_sql_query($db, $local_sql_query_transhumancia_t, false);
...
//        d($matches1);
                 ...
                 */
                k1_sql_insert($db, "CENSO2015_JULIO", $return_array['censo']);
            }
            /**
             * J_ID
             */
...
//                            d($matches2);
                ...
                if (!empty($matches2[2][0])) {
                    k1_sql_insert($db, "CENSO2015_INSCRIPCIONES", $return_array['inscripcion']);
                }
            }
