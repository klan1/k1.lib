...
function k1_on_app_session($redirect = true, $url_to_redirect = "/") {
    ...
    if ($redirect) {
        ...
        $url_save_flag = k1_unserialize_var("url-save-flag");
        $last_url = k1_get_app_link(str_replace(APP_DIR, "", $_SERVER['REQUEST_URI']));
        k1_serialize_var($url_save_flag, "url-save-flag");
        k1_serialize_var($last_url, "last-url");
    }
