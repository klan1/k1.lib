...
class input_helper {
    ...
    static function enum_type(creating $crudlex_obj, $row_to_apply, $field) {
        ...
        $input_tag = new \k1lib\html\select_tag($crudlex_obj->encrypt_field_name($field));
    ...
    static function default_type(creating $crudlex_obj, $field) {
        if (!empty($crudlex_obj->db_table->get_field_config($field, 'refereced_table_name'))) {
            ...
            $input_tag = new \k1lib\html\input_tag("text", $crudlex_obj->encrypt_field_name($field), NULL, "k1-input-insert input-group-field");
...
//            }
            ...
            $input_tag = new \k1lib\html\input_tag("text", $crudlex_obj->encrypt_field_name($field), NULL, "k1-input-insert input-group-field datepicker");
            ...
            $input_tag = new \k1lib\html\input_tag("text", $crudlex_obj->encrypt_field_name($field), NULL, "k1-input-insert");
